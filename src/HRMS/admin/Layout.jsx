  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex font-primary antialiased">
      ...
      >
        ...
        {/* Navigation */}
        <nav className="p-2 space-y-2 overflow-y-auto h-[calc(100vh-4rem)]">
                ...
                <div>
                  <button
                    ...
                    className={cn(
                      ...
                      openMenus[menu.id] ?"bg-primary-card-light rounded-t-lg rounded-b-none":"",
                      isMenuActive(menu)
                        ? "bg-primary/20 text-primary-light"
                        : "text-white hover:text-primary hover:bg-neutral-800"
                    )}
                  ...
                  >
                    <div className="space-y-1 bg-primary-card-light rounded-b-lg border-t-2 border-primary-border  p-2">
